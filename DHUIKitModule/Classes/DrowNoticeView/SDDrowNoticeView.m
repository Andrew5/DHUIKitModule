...
+ (instancetype)createDrowNoticeView:(NSArray*)stringArray{
    ...
    drowView.frame = CGRectMake(0, [UIScreen mainScreen].bounds.size.height >=812?-54:-selfHeight, selfWith, [UIScreen mainScreen].bounds.size.height >=812?selfHeight:selfHeight);
